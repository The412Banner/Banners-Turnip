...
build_lib_for_android(){
	...
	MESA_VERSION=$(cat VERSION 2>/dev/null | tr -d '[:space:]' || echo "unknown")
...
{
  "schemaVersion": 1,
  "name": "Turnip v${MESA_VERSION}-${BUILD_DATE} (${GITHASH})",
  "description": "A6xx/A7xx/A8xx Turnip driver built from Mesa main (git ${GITHASH}). KGSL build.",
  "author": "The412Banner",
  "packageVersion": "1",
  "vendor": "Mesa",
